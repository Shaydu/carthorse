...
async function testVeryLowThreshold() {
  const pool = new Pool(dbConfig);
  
  try {
    console.log('🔍 Testing with very low threshold...');
    
    // Test with no cost threshold at all
    ...
    console.log(`🎯 Found ${bearCanyonCycles} cycles containing Bear Canyon nodes with no threshold!`);
    
    // Let's also check what cycles are actually being found
