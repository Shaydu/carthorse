-- Fix the copy_and_split_trails_to_staging_native function to compute geometry_text and geometry_hash
-- from the binary geometry column instead of expecting them from the source table
