...
--
-- Name: staging_boulder_1753984170667; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA staging_boulder_1753984170667;


--
-- Name: staging_boulder_1753984365302; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA staging_boulder_1753984365302;


--
-- Name: staging_boulder_1753984590124; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA staging_boulder_1753984590124;


--
-- Name: staging_boulder_1753985356118; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA staging_boulder_1753985356118;


--
-- Name: staging_boulder_1753985398471; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA staging_boulder_1753985398471;
...
CREATE FUNCTION public.calculate_route_similarity_score(actual_distance double precision, target_distance double precision, actual_elevation double precision, target_elevation double precision) RETURNS double precision
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public.generate_routing_edges_native(staging_schema text, tolerance_meters real DEFAULT 2.0) RETURNS TABLE(edge_count integer, success boolean, message text)
    LANGUAGE plpgsql
    AS $$ BEGIN RETURN QUERY SELECT build_routing_edges(staging_schema, 'trails', tolerance_meters), true, format('Successfully generated routing edges using build_routing_edges with tolerance %s meters', tolerance_meters); END; $$;
...
CREATE FUNCTION public.get_intersection_tolerance() RETURNS real
    LANGUAGE plpgsql
    AS $$ BEGIN RETURN 2.0; END; $$;
...
CREATE FUNCTION public.generate_routing_nodes_native(staging_schema text, tolerance_meters real DEFAULT public.get_intersection_tolerance()) RETURNS TABLE(node_count integer, success boolean, message text)
    LANGUAGE plpgsql
    AS $_$
DECLARE
...
--
-- Name: generate_routing_nodes_native(text, double precision); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.generate_routing_nodes_native(staging_schema text, intersection_tolerance_meters double precision DEFAULT 2.0) RETURNS TABLE(node_count integer, success boolean, message text)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: route_patterns; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: route_patterns_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.route_patterns_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: route_patterns_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.route_patterns_id_seq OWNED BY public.route_patterns.id;
...
--
-- Name: intersection_points; Type: TABLE; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE TABLE staging_boulder_1753984170667.intersection_points (
    id integer NOT NULL,
    point public.geometry(Point,4326),
    point_3d public.geometry(PointZ,4326),
    connected_trail_ids text[],
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984170667.intersection_points_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984170667.intersection_points_id_seq OWNED BY staging_boulder_1753984170667.intersection_points.id;


--
-- Name: routing_edges; Type: TABLE; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE TABLE staging_boulder_1753984170667.routing_edges (
    id integer NOT NULL,
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984170667.routing_edges_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984170667.routing_edges_id_seq OWNED BY staging_boulder_1753984170667.routing_edges.id;


--
-- Name: routing_nodes; Type: TABLE; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE TABLE staging_boulder_1753984170667.routing_nodes (
    id integer NOT NULL,
    node_uuid text,
    lat real,
    lng real,
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984170667.routing_nodes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984170667.routing_nodes_id_seq OWNED BY staging_boulder_1753984170667.routing_nodes.id;


--
-- Name: trail_hashes; Type: TABLE; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE TABLE staging_boulder_1753984170667.trail_hashes (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    geometry_hash text NOT NULL,
    created_at timestamp without time zone DEFAULT now()
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984170667.trail_hashes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984170667.trail_hashes_id_seq OWNED BY staging_boulder_1753984170667.trail_hashes.id;


--
-- Name: trails; Type: TABLE; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE TABLE staging_boulder_1753984170667.trails (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    osm_id text,
    name text NOT NULL,
...
--
-- Name: trails_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984170667.trails_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trails_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984170667.trails_id_seq OWNED BY staging_boulder_1753984170667.trails.id;


--
-- Name: intersection_points; Type: TABLE; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE TABLE staging_boulder_1753984365302.intersection_points (
    id integer NOT NULL,
    point public.geometry(Point,4326),
    point_3d public.geometry(PointZ,4326),
    connected_trail_ids text[],
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984365302.intersection_points_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984365302.intersection_points_id_seq OWNED BY staging_boulder_1753984365302.intersection_points.id;


--
-- Name: routing_edges; Type: TABLE; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE TABLE staging_boulder_1753984365302.routing_edges (
    id integer NOT NULL,
    source integer NOT NULL,
    target integer NOT NULL,
    trail_id text NOT NULL,
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984365302.routing_edges_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984365302.routing_edges_id_seq OWNED BY staging_boulder_1753984365302.routing_edges.id;


--
-- Name: routing_nodes; Type: TABLE; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE TABLE staging_boulder_1753984365302.routing_nodes (
    id integer NOT NULL,
    node_uuid text,
    lat real,
    lng real,
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984365302.routing_nodes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984365302.routing_nodes_id_seq OWNED BY staging_boulder_1753984365302.routing_nodes.id;


--
-- Name: trail_hashes; Type: TABLE; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE TABLE staging_boulder_1753984365302.trail_hashes (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    geometry_hash text NOT NULL,
    created_at timestamp without time zone DEFAULT now()
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984365302.trail_hashes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984365302.trail_hashes_id_seq OWNED BY staging_boulder_1753984365302.trail_hashes.id;


--
-- Name: trails; Type: TABLE; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE TABLE staging_boulder_1753984365302.trails (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    osm_id text,
    name text NOT NULL,
...
--
-- Name: trails_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984365302.trails_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trails_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984365302.trails_id_seq OWNED BY staging_boulder_1753984365302.trails.id;


--
-- Name: intersection_points; Type: TABLE; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE TABLE staging_boulder_1753984590124.intersection_points (
    id integer NOT NULL,
    point public.geometry(Point,4326),
    point_3d public.geometry(PointZ,4326),
    connected_trail_ids text[],
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984590124.intersection_points_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984590124.intersection_points_id_seq OWNED BY staging_boulder_1753984590124.intersection_points.id;


--
-- Name: routing_edges; Type: TABLE; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE TABLE staging_boulder_1753984590124.routing_edges (
    id integer NOT NULL,
    source integer NOT NULL,
    target integer NOT NULL,
    trail_id text NOT NULL,
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984590124.routing_edges_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984590124.routing_edges_id_seq OWNED BY staging_boulder_1753984590124.routing_edges.id;


--
-- Name: routing_nodes; Type: TABLE; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE TABLE staging_boulder_1753984590124.routing_nodes (
    id integer NOT NULL,
    node_uuid text,
    lat real,
    lng real,
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984590124.routing_nodes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984590124.routing_nodes_id_seq OWNED BY staging_boulder_1753984590124.routing_nodes.id;


--
-- Name: trail_hashes; Type: TABLE; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE TABLE staging_boulder_1753984590124.trail_hashes (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    geometry_hash text NOT NULL,
    created_at timestamp without time zone DEFAULT now()
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984590124.trail_hashes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984590124.trail_hashes_id_seq OWNED BY staging_boulder_1753984590124.trail_hashes.id;


--
-- Name: trails; Type: TABLE; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE TABLE staging_boulder_1753984590124.trails (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    osm_id text,
    name text NOT NULL,
...
--
-- Name: trails_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE SEQUENCE staging_boulder_1753984590124.trails_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trails_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER SEQUENCE staging_boulder_1753984590124.trails_id_seq OWNED BY staging_boulder_1753984590124.trails.id;


--
-- Name: intersection_points; Type: TABLE; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE TABLE staging_boulder_1753985356118.intersection_points (
    id integer NOT NULL,
    point public.geometry(Point,4326),
    point_3d public.geometry(PointZ,4326),
    connected_trail_ids text[],
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE SEQUENCE staging_boulder_1753985356118.intersection_points_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER SEQUENCE staging_boulder_1753985356118.intersection_points_id_seq OWNED BY staging_boulder_1753985356118.intersection_points.id;


--
-- Name: routing_edges; Type: TABLE; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE TABLE staging_boulder_1753985356118.routing_edges (
    id integer NOT NULL,
    source integer NOT NULL,
    target integer NOT NULL,
    trail_id text NOT NULL,
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE SEQUENCE staging_boulder_1753985356118.routing_edges_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER SEQUENCE staging_boulder_1753985356118.routing_edges_id_seq OWNED BY staging_boulder_1753985356118.routing_edges.id;


--
-- Name: routing_nodes; Type: TABLE; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE TABLE staging_boulder_1753985356118.routing_nodes (
    id integer NOT NULL,
    node_uuid text,
    lat real,
    lng real,
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE SEQUENCE staging_boulder_1753985356118.routing_nodes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER SEQUENCE staging_boulder_1753985356118.routing_nodes_id_seq OWNED BY staging_boulder_1753985356118.routing_nodes.id;


--
-- Name: trail_hashes; Type: TABLE; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE TABLE staging_boulder_1753985356118.trail_hashes (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    geometry_hash text NOT NULL,
    created_at timestamp without time zone DEFAULT now()
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE SEQUENCE staging_boulder_1753985356118.trail_hashes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER SEQUENCE staging_boulder_1753985356118.trail_hashes_id_seq OWNED BY staging_boulder_1753985356118.trail_hashes.id;


--
-- Name: trails; Type: TABLE; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE TABLE staging_boulder_1753985356118.trails (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    osm_id text,
    name text NOT NULL,
...
--
-- Name: trails_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE SEQUENCE staging_boulder_1753985356118.trails_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trails_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER SEQUENCE staging_boulder_1753985356118.trails_id_seq OWNED BY staging_boulder_1753985356118.trails.id;


--
-- Name: intersection_points; Type: TABLE; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE TABLE staging_boulder_1753985398471.intersection_points (
    id integer NOT NULL,
    point public.geometry(Point,4326),
    point_3d public.geometry(PointZ,4326),
    connected_trail_ids text[],
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE SEQUENCE staging_boulder_1753985398471.intersection_points_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER SEQUENCE staging_boulder_1753985398471.intersection_points_id_seq OWNED BY staging_boulder_1753985398471.intersection_points.id;


--
-- Name: routing_edges; Type: TABLE; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE TABLE staging_boulder_1753985398471.routing_edges (
    id integer NOT NULL,
    source integer NOT NULL,
    target integer NOT NULL,
    trail_id text NOT NULL,
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE SEQUENCE staging_boulder_1753985398471.routing_edges_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER SEQUENCE staging_boulder_1753985398471.routing_edges_id_seq OWNED BY staging_boulder_1753985398471.routing_edges.id;


--
-- Name: routing_nodes; Type: TABLE; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE TABLE staging_boulder_1753985398471.routing_nodes (
    id integer NOT NULL,
    node_uuid text,
    lat real,
    lng real,
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE SEQUENCE staging_boulder_1753985398471.routing_nodes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER SEQUENCE staging_boulder_1753985398471.routing_nodes_id_seq OWNED BY staging_boulder_1753985398471.routing_nodes.id;


--
-- Name: trail_hashes; Type: TABLE; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE TABLE staging_boulder_1753985398471.trail_hashes (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    geometry_hash text NOT NULL,
    created_at timestamp without time zone DEFAULT now()
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE SEQUENCE staging_boulder_1753985398471.trail_hashes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER SEQUENCE staging_boulder_1753985398471.trail_hashes_id_seq OWNED BY staging_boulder_1753985398471.trail_hashes.id;


--
-- Name: trails; Type: TABLE; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE TABLE staging_boulder_1753985398471.trails (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    osm_id text,
    name text NOT NULL,
...
--
-- Name: trails_id_seq; Type: SEQUENCE; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE SEQUENCE staging_boulder_1753985398471.trails_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trails_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER SEQUENCE staging_boulder_1753985398471.trails_id_seq OWNED BY staging_boulder_1753985398471.trails.id;
...
--
-- Name: route_patterns id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.route_patterns ALTER COLUMN id SET DEFAULT nextval('public.route_patterns_id_seq'::regclass);
...
--
-- Name: intersection_points id; Type: DEFAULT; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984170667.intersection_points ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984170667.intersection_points_id_seq'::regclass);


--
-- Name: routing_edges id; Type: DEFAULT; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984170667.routing_edges ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984170667.routing_edges_id_seq'::regclass);


--
-- Name: routing_nodes id; Type: DEFAULT; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984170667.routing_nodes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984170667.routing_nodes_id_seq'::regclass);


--
-- Name: trail_hashes id; Type: DEFAULT; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984170667.trail_hashes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984170667.trail_hashes_id_seq'::regclass);


--
-- Name: trails id; Type: DEFAULT; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984170667.trails ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984170667.trails_id_seq'::regclass);


--
-- Name: intersection_points id; Type: DEFAULT; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984365302.intersection_points ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984365302.intersection_points_id_seq'::regclass);


--
-- Name: routing_edges id; Type: DEFAULT; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984365302.routing_edges ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984365302.routing_edges_id_seq'::regclass);


--
-- Name: routing_nodes id; Type: DEFAULT; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984365302.routing_nodes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984365302.routing_nodes_id_seq'::regclass);


--
-- Name: trail_hashes id; Type: DEFAULT; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984365302.trail_hashes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984365302.trail_hashes_id_seq'::regclass);


--
-- Name: trails id; Type: DEFAULT; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984365302.trails ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984365302.trails_id_seq'::regclass);


--
-- Name: intersection_points id; Type: DEFAULT; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984590124.intersection_points ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984590124.intersection_points_id_seq'::regclass);


--
-- Name: routing_edges id; Type: DEFAULT; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984590124.routing_edges ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984590124.routing_edges_id_seq'::regclass);


--
-- Name: routing_nodes id; Type: DEFAULT; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984590124.routing_nodes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984590124.routing_nodes_id_seq'::regclass);


--
-- Name: trail_hashes id; Type: DEFAULT; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984590124.trail_hashes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984590124.trail_hashes_id_seq'::regclass);


--
-- Name: trails id; Type: DEFAULT; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984590124.trails ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753984590124.trails_id_seq'::regclass);


--
-- Name: intersection_points id; Type: DEFAULT; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985356118.intersection_points ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753985356118.intersection_points_id_seq'::regclass);


--
-- Name: routing_edges id; Type: DEFAULT; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985356118.routing_edges ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753985356118.routing_edges_id_seq'::regclass);


--
-- Name: routing_nodes id; Type: DEFAULT; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985356118.routing_nodes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753985356118.routing_nodes_id_seq'::regclass);


--
-- Name: trail_hashes id; Type: DEFAULT; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985356118.trail_hashes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753985356118.trail_hashes_id_seq'::regclass);


--
-- Name: trails id; Type: DEFAULT; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985356118.trails ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753985356118.trails_id_seq'::regclass);


--
-- Name: intersection_points id; Type: DEFAULT; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985398471.intersection_points ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753985398471.intersection_points_id_seq'::regclass);


--
-- Name: routing_edges id; Type: DEFAULT; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985398471.routing_edges ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753985398471.routing_edges_id_seq'::regclass);


--
-- Name: routing_nodes id; Type: DEFAULT; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985398471.routing_nodes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753985398471.routing_nodes_id_seq'::regclass);


--
-- Name: trail_hashes id; Type: DEFAULT; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985398471.trail_hashes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753985398471.trail_hashes_id_seq'::regclass);


--
-- Name: trails id; Type: DEFAULT; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985398471.trails ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1753985398471.trails_id_seq'::regclass);
...
--
-- Name: route_patterns route_patterns_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.route_patterns
    ADD CONSTRAINT route_patterns_pkey PRIMARY KEY (id);
...
--
-- Name: intersection_points intersection_points_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984170667.intersection_points
    ADD CONSTRAINT intersection_points_pkey PRIMARY KEY (id);


--
-- Name: routing_edges routing_edges_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984170667.routing_edges
    ADD CONSTRAINT routing_edges_pkey PRIMARY KEY (id);


--
-- Name: routing_nodes routing_nodes_node_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984170667.routing_nodes
    ADD CONSTRAINT routing_nodes_node_uuid_key UNIQUE (node_uuid);


--
-- Name: routing_nodes routing_nodes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984170667; Owner: -
--
...
--
-- Name: trail_hashes trail_hashes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984170667.trail_hashes
    ADD CONSTRAINT trail_hashes_pkey PRIMARY KEY (id);


--
-- Name: trails trails_app_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984170667.trails
    ADD CONSTRAINT trails_app_uuid_key UNIQUE (app_uuid);


--
-- Name: trails trails_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984170667; Owner: -
--
...
--
-- Name: intersection_points intersection_points_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984365302.intersection_points
    ADD CONSTRAINT intersection_points_pkey PRIMARY KEY (id);


--
-- Name: routing_edges routing_edges_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984365302.routing_edges
    ADD CONSTRAINT routing_edges_pkey PRIMARY KEY (id);


--
-- Name: routing_nodes routing_nodes_node_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984365302.routing_nodes
    ADD CONSTRAINT routing_nodes_node_uuid_key UNIQUE (node_uuid);


--
-- Name: routing_nodes routing_nodes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984365302; Owner: -
--
...
--
-- Name: trail_hashes trail_hashes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984365302.trail_hashes
    ADD CONSTRAINT trail_hashes_pkey PRIMARY KEY (id);


--
-- Name: trails trails_app_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984365302.trails
    ADD CONSTRAINT trails_app_uuid_key UNIQUE (app_uuid);


--
-- Name: trails trails_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984365302; Owner: -
--
...
--
-- Name: intersection_points intersection_points_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984590124.intersection_points
    ADD CONSTRAINT intersection_points_pkey PRIMARY KEY (id);


--
-- Name: routing_edges routing_edges_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984590124.routing_edges
    ADD CONSTRAINT routing_edges_pkey PRIMARY KEY (id);


--
-- Name: routing_nodes routing_nodes_node_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984590124.routing_nodes
    ADD CONSTRAINT routing_nodes_node_uuid_key UNIQUE (node_uuid);


--
-- Name: routing_nodes routing_nodes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984590124; Owner: -
--
...
--
-- Name: trail_hashes trail_hashes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984590124.trail_hashes
    ADD CONSTRAINT trail_hashes_pkey PRIMARY KEY (id);


--
-- Name: trails trails_app_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984590124.trails
    ADD CONSTRAINT trails_app_uuid_key UNIQUE (app_uuid);


--
-- Name: trails trails_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753984590124; Owner: -
--
...
--
-- Name: intersection_points intersection_points_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985356118.intersection_points
    ADD CONSTRAINT intersection_points_pkey PRIMARY KEY (id);


--
-- Name: routing_edges routing_edges_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985356118.routing_edges
    ADD CONSTRAINT routing_edges_pkey PRIMARY KEY (id);


--
-- Name: routing_nodes routing_nodes_node_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985356118.routing_nodes
    ADD CONSTRAINT routing_nodes_node_uuid_key UNIQUE (node_uuid);


--
-- Name: routing_nodes routing_nodes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753985356118; Owner: -
--
...
--
-- Name: trail_hashes trail_hashes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985356118.trail_hashes
    ADD CONSTRAINT trail_hashes_pkey PRIMARY KEY (id);


--
-- Name: trails trails_app_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985356118.trails
    ADD CONSTRAINT trails_app_uuid_key UNIQUE (app_uuid);


--
-- Name: trails trails_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753985356118; Owner: -
--
...
--
-- Name: intersection_points intersection_points_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985398471.intersection_points
    ADD CONSTRAINT intersection_points_pkey PRIMARY KEY (id);


--
-- Name: routing_edges routing_edges_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985398471.routing_edges
    ADD CONSTRAINT routing_edges_pkey PRIMARY KEY (id);


--
-- Name: routing_nodes routing_nodes_node_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985398471.routing_nodes
    ADD CONSTRAINT routing_nodes_node_uuid_key UNIQUE (node_uuid);


--
-- Name: routing_nodes routing_nodes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753985398471; Owner: -
--
...
--
-- Name: trail_hashes trail_hashes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985398471.trail_hashes
    ADD CONSTRAINT trail_hashes_pkey PRIMARY KEY (id);


--
-- Name: trails trails_app_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985398471.trails
    ADD CONSTRAINT trails_app_uuid_key UNIQUE (app_uuid);


--
-- Name: trails trails_pkey; Type: CONSTRAINT; Schema: staging_boulder_1753985398471; Owner: -
--
...
--
-- Name: idx_intersection_points; Type: INDEX; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE INDEX idx_intersection_points ON staging_boulder_1753984170667.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1753984170667_intersection_points; Type: INDEX; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE INDEX idx_staging_boulder_1753984170667_intersection_points ON staging_boulder_1753984170667.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1753984170667_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE INDEX idx_staging_boulder_1753984170667_routing_edges_geometry ON staging_boulder_1753984170667.routing_edges USING gist (geometry);


--
-- Name: idx_staging_boulder_1753984170667_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE INDEX idx_staging_boulder_1753984170667_routing_nodes_location ON staging_boulder_1753984170667.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_boulder_1753984170667_trails_geometry; Type: INDEX; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE INDEX idx_staging_boulder_1753984170667_trails_geometry ON staging_boulder_1753984170667.trails USING gist (geometry);


--
-- Name: idx_staging_intersection_points; Type: INDEX; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE INDEX idx_staging_intersection_points ON staging_boulder_1753984170667.intersection_points USING gist (point);


--
-- Name: idx_staging_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE INDEX idx_staging_routing_edges_geometry ON staging_boulder_1753984170667.routing_edges USING gist (geometry);


--
-- Name: idx_staging_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE INDEX idx_staging_routing_nodes_location ON staging_boulder_1753984170667.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_trails_geometry; Type: INDEX; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE INDEX idx_staging_trails_geometry ON staging_boulder_1753984170667.trails USING gist (geometry);


--
-- Name: idx_trails_app_uuid; Type: INDEX; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE INDEX idx_trails_app_uuid ON staging_boulder_1753984170667.trails USING btree (app_uuid);


--
-- Name: idx_trails_geometry; Type: INDEX; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE INDEX idx_trails_geometry ON staging_boulder_1753984170667.trails USING gist (geometry);


--
-- Name: idx_trails_name; Type: INDEX; Schema: staging_boulder_1753984170667; Owner: -
--

CREATE INDEX idx_trails_name ON staging_boulder_1753984170667.trails USING btree (name);


--
-- Name: idx_intersection_points; Type: INDEX; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE INDEX idx_intersection_points ON staging_boulder_1753984365302.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1753984365302_intersection_points; Type: INDEX; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE INDEX idx_staging_boulder_1753984365302_intersection_points ON staging_boulder_1753984365302.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1753984365302_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE INDEX idx_staging_boulder_1753984365302_routing_edges_geometry ON staging_boulder_1753984365302.routing_edges USING gist (geometry);


--
-- Name: idx_staging_boulder_1753984365302_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE INDEX idx_staging_boulder_1753984365302_routing_nodes_location ON staging_boulder_1753984365302.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_boulder_1753984365302_trails_geometry; Type: INDEX; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE INDEX idx_staging_boulder_1753984365302_trails_geometry ON staging_boulder_1753984365302.trails USING gist (geometry);


--
-- Name: idx_staging_intersection_points; Type: INDEX; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE INDEX idx_staging_intersection_points ON staging_boulder_1753984365302.intersection_points USING gist (point);


--
-- Name: idx_staging_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE INDEX idx_staging_routing_edges_geometry ON staging_boulder_1753984365302.routing_edges USING gist (geometry);


--
-- Name: idx_staging_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE INDEX idx_staging_routing_nodes_location ON staging_boulder_1753984365302.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_trails_geometry; Type: INDEX; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE INDEX idx_staging_trails_geometry ON staging_boulder_1753984365302.trails USING gist (geometry);


--
-- Name: idx_trails_app_uuid; Type: INDEX; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE INDEX idx_trails_app_uuid ON staging_boulder_1753984365302.trails USING btree (app_uuid);


--
-- Name: idx_trails_geometry; Type: INDEX; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE INDEX idx_trails_geometry ON staging_boulder_1753984365302.trails USING gist (geometry);


--
-- Name: idx_trails_name; Type: INDEX; Schema: staging_boulder_1753984365302; Owner: -
--

CREATE INDEX idx_trails_name ON staging_boulder_1753984365302.trails USING btree (name);


--
-- Name: idx_intersection_points; Type: INDEX; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE INDEX idx_intersection_points ON staging_boulder_1753984590124.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1753984590124_intersection_points; Type: INDEX; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE INDEX idx_staging_boulder_1753984590124_intersection_points ON staging_boulder_1753984590124.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1753984590124_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE INDEX idx_staging_boulder_1753984590124_routing_edges_geometry ON staging_boulder_1753984590124.routing_edges USING gist (geometry);


--
-- Name: idx_staging_boulder_1753984590124_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE INDEX idx_staging_boulder_1753984590124_routing_nodes_location ON staging_boulder_1753984590124.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_boulder_1753984590124_trails_geometry; Type: INDEX; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE INDEX idx_staging_boulder_1753984590124_trails_geometry ON staging_boulder_1753984590124.trails USING gist (geometry);


--
-- Name: idx_staging_intersection_points; Type: INDEX; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE INDEX idx_staging_intersection_points ON staging_boulder_1753984590124.intersection_points USING gist (point);


--
-- Name: idx_staging_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE INDEX idx_staging_routing_edges_geometry ON staging_boulder_1753984590124.routing_edges USING gist (geometry);


--
-- Name: idx_staging_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE INDEX idx_staging_routing_nodes_location ON staging_boulder_1753984590124.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_trails_geometry; Type: INDEX; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE INDEX idx_staging_trails_geometry ON staging_boulder_1753984590124.trails USING gist (geometry);


--
-- Name: idx_trails_app_uuid; Type: INDEX; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE INDEX idx_trails_app_uuid ON staging_boulder_1753984590124.trails USING btree (app_uuid);


--
-- Name: idx_trails_geometry; Type: INDEX; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE INDEX idx_trails_geometry ON staging_boulder_1753984590124.trails USING gist (geometry);


--
-- Name: idx_trails_name; Type: INDEX; Schema: staging_boulder_1753984590124; Owner: -
--

CREATE INDEX idx_trails_name ON staging_boulder_1753984590124.trails USING btree (name);


--
-- Name: idx_intersection_points; Type: INDEX; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE INDEX idx_intersection_points ON staging_boulder_1753985356118.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1753985356118_intersection_points; Type: INDEX; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE INDEX idx_staging_boulder_1753985356118_intersection_points ON staging_boulder_1753985356118.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1753985356118_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE INDEX idx_staging_boulder_1753985356118_routing_edges_geometry ON staging_boulder_1753985356118.routing_edges USING gist (geometry);


--
-- Name: idx_staging_boulder_1753985356118_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE INDEX idx_staging_boulder_1753985356118_routing_nodes_location ON staging_boulder_1753985356118.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_boulder_1753985356118_trails_geometry; Type: INDEX; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE INDEX idx_staging_boulder_1753985356118_trails_geometry ON staging_boulder_1753985356118.trails USING gist (geometry);


--
-- Name: idx_staging_intersection_points; Type: INDEX; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE INDEX idx_staging_intersection_points ON staging_boulder_1753985356118.intersection_points USING gist (point);


--
-- Name: idx_staging_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE INDEX idx_staging_routing_edges_geometry ON staging_boulder_1753985356118.routing_edges USING gist (geometry);


--
-- Name: idx_staging_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE INDEX idx_staging_routing_nodes_location ON staging_boulder_1753985356118.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_trails_geometry; Type: INDEX; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE INDEX idx_staging_trails_geometry ON staging_boulder_1753985356118.trails USING gist (geometry);


--
-- Name: idx_trails_app_uuid; Type: INDEX; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE INDEX idx_trails_app_uuid ON staging_boulder_1753985356118.trails USING btree (app_uuid);


--
-- Name: idx_trails_geometry; Type: INDEX; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE INDEX idx_trails_geometry ON staging_boulder_1753985356118.trails USING gist (geometry);


--
-- Name: idx_trails_name; Type: INDEX; Schema: staging_boulder_1753985356118; Owner: -
--

CREATE INDEX idx_trails_name ON staging_boulder_1753985356118.trails USING btree (name);


--
-- Name: idx_intersection_points; Type: INDEX; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE INDEX idx_intersection_points ON staging_boulder_1753985398471.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1753985398471_intersection_points; Type: INDEX; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE INDEX idx_staging_boulder_1753985398471_intersection_points ON staging_boulder_1753985398471.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1753985398471_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE INDEX idx_staging_boulder_1753985398471_routing_edges_geometry ON staging_boulder_1753985398471.routing_edges USING gist (geometry);


--
-- Name: idx_staging_boulder_1753985398471_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE INDEX idx_staging_boulder_1753985398471_routing_nodes_location ON staging_boulder_1753985398471.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_boulder_1753985398471_trails_geometry; Type: INDEX; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE INDEX idx_staging_boulder_1753985398471_trails_geometry ON staging_boulder_1753985398471.trails USING gist (geometry);


--
-- Name: idx_staging_intersection_points; Type: INDEX; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE INDEX idx_staging_intersection_points ON staging_boulder_1753985398471.intersection_points USING gist (point);


--
-- Name: idx_staging_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE INDEX idx_staging_routing_edges_geometry ON staging_boulder_1753985398471.routing_edges USING gist (geometry);


--
-- Name: idx_staging_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE INDEX idx_staging_routing_nodes_location ON staging_boulder_1753985398471.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_trails_geometry; Type: INDEX; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE INDEX idx_staging_trails_geometry ON staging_boulder_1753985398471.trails USING gist (geometry);


--
-- Name: idx_trails_app_uuid; Type: INDEX; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE INDEX idx_trails_app_uuid ON staging_boulder_1753985398471.trails USING btree (app_uuid);


--
-- Name: idx_trails_geometry; Type: INDEX; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE INDEX idx_trails_geometry ON staging_boulder_1753985398471.trails USING gist (geometry);


--
-- Name: idx_trails_name; Type: INDEX; Schema: staging_boulder_1753985398471; Owner: -
--

CREATE INDEX idx_trails_name ON staging_boulder_1753985398471.trails USING btree (name);
...
--
-- Name: routing_edges routing_edges_source_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984170667.routing_edges
    ADD CONSTRAINT routing_edges_source_fkey FOREIGN KEY (source) REFERENCES staging_boulder_1753984170667.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_target_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1753984170667; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984170667.routing_edges
    ADD CONSTRAINT routing_edges_target_fkey FOREIGN KEY (target) REFERENCES staging_boulder_1753984170667.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_source_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984365302.routing_edges
    ADD CONSTRAINT routing_edges_source_fkey FOREIGN KEY (source) REFERENCES staging_boulder_1753984365302.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_target_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1753984365302; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984365302.routing_edges
    ADD CONSTRAINT routing_edges_target_fkey FOREIGN KEY (target) REFERENCES staging_boulder_1753984365302.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_source_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984590124.routing_edges
    ADD CONSTRAINT routing_edges_source_fkey FOREIGN KEY (source) REFERENCES staging_boulder_1753984590124.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_target_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1753984590124; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753984590124.routing_edges
    ADD CONSTRAINT routing_edges_target_fkey FOREIGN KEY (target) REFERENCES staging_boulder_1753984590124.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_source_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985356118.routing_edges
    ADD CONSTRAINT routing_edges_source_fkey FOREIGN KEY (source) REFERENCES staging_boulder_1753985356118.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_target_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1753985356118; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985356118.routing_edges
    ADD CONSTRAINT routing_edges_target_fkey FOREIGN KEY (target) REFERENCES staging_boulder_1753985356118.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_source_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985398471.routing_edges
    ADD CONSTRAINT routing_edges_source_fkey FOREIGN KEY (source) REFERENCES staging_boulder_1753985398471.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_target_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1753985398471; Owner: -
--

ALTER TABLE ONLY staging_boulder_1753985398471.routing_edges
    ADD CONSTRAINT routing_edges_target_fkey FOREIGN KEY (target) REFERENCES staging_boulder_1753985398471.routing_nodes(id) ON DELETE CASCADE;
