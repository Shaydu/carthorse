-- Prototype 2: Actual Coordinates Rounded to Match Prototype 1 Precision
-- Rounds coordinates to 6 decimal places to create the same intersection as prototype 1
...
SELECT 'Enchanted Mesa Trail (Actual Coords - Rounded)' AS trail_name, geom, ST_Length(geom::geography) as length_meters FROM split_enchanted_mesa
UNION ALL
SELECT 'Enchanted-Kohler Spur Trail (Actual Coords - Rounded)' AS trail_name, geom, ST_Length(geom::geography) as length_meters FROM split_enchanted_kohler
