-- Fixed route recommendations function for UUID-based schema - NO TRAIL NAMES
...
BEGIN
    ...
    RETURN QUERY EXECUTE format($f$
        ...
        valid_routes AS (
            ...
            GROUP BY start_node, end_node, total_distance_km, total_elevation_gain, path, edges, segment_count
        )
        SELECT 
            route_id,
            start_node,
...
-- Fixed route recommendations generation function - NO TRAIL NAMES
