...
--
-- Name: staging_boulder_1754017717775; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA staging_boulder_1754017717775;


--
-- Name: staging_boulder_1754017877721; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA staging_boulder_1754017877721;


--
-- Name: staging_boulder_1754018197814; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA staging_boulder_1754018197814;


--
-- Name: staging_boulder_1754058115529; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA staging_boulder_1754058115529;
...
CREATE FUNCTION public.generate_routing_edges_native(staging_schema text, tolerance_meters real DEFAULT 0.0001) RETURNS TABLE(edge_count integer, success boolean, message text)
    LANGUAGE plpgsql
    AS $_$
DECLARE
...
--
-- Name: FUNCTION generate_routing_edges_native(staging_schema text, tolerance_meters real); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.generate_routing_edges_native(staging_schema text, tolerance_meters real) IS 'Updated to use correct column names (geometry instead of geom)';
...
CREATE FUNCTION public.generate_routing_nodes_native(staging_schema text, tolerance_meters real DEFAULT 0.0001) RETURNS TABLE(node_count integer, success boolean, message text)
    LANGUAGE plpgsql
    AS $_$
DECLARE
    node_count_var integer := 0;
...
--
-- Name: FUNCTION generate_routing_nodes_native(staging_schema text, tolerance_meters real); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.generate_routing_nodes_native(staging_schema text, tolerance_meters real) IS 'Updated to handle 3D geometry properly';
...
--
-- Name: intersection_points; Type: TABLE; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE TABLE staging_boulder_1754017717775.intersection_points (
    id integer NOT NULL,
    point public.geometry(Point,4326),
    point_3d public.geometry(PointZ,4326),
    connected_trail_ids text[],
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE SEQUENCE staging_boulder_1754017717775.intersection_points_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER SEQUENCE staging_boulder_1754017717775.intersection_points_id_seq OWNED BY staging_boulder_1754017717775.intersection_points.id;


--
-- Name: routing_edges; Type: TABLE; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE TABLE staging_boulder_1754017717775.routing_edges (
    id integer NOT NULL,
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE SEQUENCE staging_boulder_1754017717775.routing_edges_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER SEQUENCE staging_boulder_1754017717775.routing_edges_id_seq OWNED BY staging_boulder_1754017717775.routing_edges.id;


--
-- Name: routing_nodes; Type: TABLE; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE TABLE staging_boulder_1754017717775.routing_nodes (
    id integer NOT NULL,
    node_uuid text,
    lat real,
    lng real,
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE SEQUENCE staging_boulder_1754017717775.routing_nodes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER SEQUENCE staging_boulder_1754017717775.routing_nodes_id_seq OWNED BY staging_boulder_1754017717775.routing_nodes.id;


--
-- Name: trail_hashes; Type: TABLE; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE TABLE staging_boulder_1754017717775.trail_hashes (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    geometry_hash text NOT NULL,
    created_at timestamp without time zone DEFAULT now()
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE SEQUENCE staging_boulder_1754017717775.trail_hashes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER SEQUENCE staging_boulder_1754017717775.trail_hashes_id_seq OWNED BY staging_boulder_1754017717775.trail_hashes.id;


--
-- Name: trails; Type: TABLE; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE TABLE staging_boulder_1754017717775.trails (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    osm_id text,
    name text NOT NULL,
...
--
-- Name: trails_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE SEQUENCE staging_boulder_1754017717775.trails_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trails_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER SEQUENCE staging_boulder_1754017717775.trails_id_seq OWNED BY staging_boulder_1754017717775.trails.id;


--
-- Name: intersection_points; Type: TABLE; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE TABLE staging_boulder_1754017877721.intersection_points (
    id integer NOT NULL,
    point public.geometry(Point,4326),
    point_3d public.geometry(PointZ,4326),
    connected_trail_ids text[],
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE SEQUENCE staging_boulder_1754017877721.intersection_points_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER SEQUENCE staging_boulder_1754017877721.intersection_points_id_seq OWNED BY staging_boulder_1754017877721.intersection_points.id;


--
-- Name: routing_edges; Type: TABLE; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE TABLE staging_boulder_1754017877721.routing_edges (
    id integer NOT NULL,
    source integer NOT NULL,
    target integer NOT NULL,
    trail_id text NOT NULL,
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE SEQUENCE staging_boulder_1754017877721.routing_edges_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER SEQUENCE staging_boulder_1754017877721.routing_edges_id_seq OWNED BY staging_boulder_1754017877721.routing_edges.id;


--
-- Name: routing_nodes; Type: TABLE; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE TABLE staging_boulder_1754017877721.routing_nodes (
    id integer NOT NULL,
    node_uuid text,
    lat real,
    lng real,
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE SEQUENCE staging_boulder_1754017877721.routing_nodes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER SEQUENCE staging_boulder_1754017877721.routing_nodes_id_seq OWNED BY staging_boulder_1754017877721.routing_nodes.id;


--
-- Name: trail_hashes; Type: TABLE; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE TABLE staging_boulder_1754017877721.trail_hashes (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    geometry_hash text NOT NULL,
    created_at timestamp without time zone DEFAULT now()
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE SEQUENCE staging_boulder_1754017877721.trail_hashes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER SEQUENCE staging_boulder_1754017877721.trail_hashes_id_seq OWNED BY staging_boulder_1754017877721.trail_hashes.id;


--
-- Name: trails; Type: TABLE; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE TABLE staging_boulder_1754017877721.trails (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    osm_id text,
    name text NOT NULL,
...
--
-- Name: trails_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE SEQUENCE staging_boulder_1754017877721.trails_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trails_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER SEQUENCE staging_boulder_1754017877721.trails_id_seq OWNED BY staging_boulder_1754017877721.trails.id;


--
-- Name: intersection_points; Type: TABLE; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE TABLE staging_boulder_1754018197814.intersection_points (
    id integer NOT NULL,
    point public.geometry(Point,4326),
    point_3d public.geometry(PointZ,4326),
    connected_trail_ids text[],
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE SEQUENCE staging_boulder_1754018197814.intersection_points_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER SEQUENCE staging_boulder_1754018197814.intersection_points_id_seq OWNED BY staging_boulder_1754018197814.intersection_points.id;


--
-- Name: routing_edges; Type: TABLE; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE TABLE staging_boulder_1754018197814.routing_edges (
    id integer NOT NULL,
    source integer NOT NULL,
    target integer NOT NULL,
    trail_id text NOT NULL,
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE SEQUENCE staging_boulder_1754018197814.routing_edges_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER SEQUENCE staging_boulder_1754018197814.routing_edges_id_seq OWNED BY staging_boulder_1754018197814.routing_edges.id;


--
-- Name: routing_nodes; Type: TABLE; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE TABLE staging_boulder_1754018197814.routing_nodes (
    id integer NOT NULL,
    node_uuid text,
    lat real,
    lng real,
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE SEQUENCE staging_boulder_1754018197814.routing_nodes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER SEQUENCE staging_boulder_1754018197814.routing_nodes_id_seq OWNED BY staging_boulder_1754018197814.routing_nodes.id;


--
-- Name: trail_hashes; Type: TABLE; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE TABLE staging_boulder_1754018197814.trail_hashes (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    geometry_hash text NOT NULL,
    created_at timestamp without time zone DEFAULT now()
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE SEQUENCE staging_boulder_1754018197814.trail_hashes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER SEQUENCE staging_boulder_1754018197814.trail_hashes_id_seq OWNED BY staging_boulder_1754018197814.trail_hashes.id;


--
-- Name: trails; Type: TABLE; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE TABLE staging_boulder_1754018197814.trails (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    osm_id text,
    name text NOT NULL,
...
--
-- Name: trails_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE SEQUENCE staging_boulder_1754018197814.trails_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trails_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER SEQUENCE staging_boulder_1754018197814.trails_id_seq OWNED BY staging_boulder_1754018197814.trails.id;


--
-- Name: intersection_points; Type: TABLE; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE TABLE staging_boulder_1754058115529.intersection_points (
    id integer NOT NULL,
    point public.geometry(Point,4326),
    point_3d public.geometry(PointZ,4326),
    connected_trail_ids text[],
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE SEQUENCE staging_boulder_1754058115529.intersection_points_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER SEQUENCE staging_boulder_1754058115529.intersection_points_id_seq OWNED BY staging_boulder_1754058115529.intersection_points.id;


--
-- Name: routing_edges; Type: TABLE; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE TABLE staging_boulder_1754058115529.routing_edges (
    id integer NOT NULL,
    source integer NOT NULL,
    target integer NOT NULL,
    trail_id text NOT NULL,
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE SEQUENCE staging_boulder_1754058115529.routing_edges_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER SEQUENCE staging_boulder_1754058115529.routing_edges_id_seq OWNED BY staging_boulder_1754058115529.routing_edges.id;


--
-- Name: routing_nodes; Type: TABLE; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE TABLE staging_boulder_1754058115529.routing_nodes (
    id integer NOT NULL,
    node_uuid text,
    lat real,
    lng real,
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE SEQUENCE staging_boulder_1754058115529.routing_nodes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER SEQUENCE staging_boulder_1754058115529.routing_nodes_id_seq OWNED BY staging_boulder_1754058115529.routing_nodes.id;


--
-- Name: trail_hashes; Type: TABLE; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE TABLE staging_boulder_1754058115529.trail_hashes (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    geometry_hash text NOT NULL,
    created_at timestamp without time zone DEFAULT now()
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE SEQUENCE staging_boulder_1754058115529.trail_hashes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER SEQUENCE staging_boulder_1754058115529.trail_hashes_id_seq OWNED BY staging_boulder_1754058115529.trail_hashes.id;


--
-- Name: trails; Type: TABLE; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE TABLE staging_boulder_1754058115529.trails (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    osm_id text,
    name text NOT NULL,
    ...
    geometry_text text,
    geometry_hash text NOT NULL,
    CONSTRAINT staging_boulder_1754058115529_trails_3d_geometry CHECK ((public.st_ndims(geometry) = 3)),
    CONSTRAINT staging_boulder_1754058115529_trails_valid_geometry CHECK (public.st_isvalid(geometry)),
    CONSTRAINT trails_elevation_gain_check CHECK (((elevation_gain IS NULL) OR (elevation_gain >= (0)::double precision))),
    CONSTRAINT trails_elevation_loss_check CHECK (((elevation_loss IS NULL) OR (elevation_loss >= (0)::double precision)))
);
...
--
-- Name: trails_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE SEQUENCE staging_boulder_1754058115529.trails_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trails_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER SEQUENCE staging_boulder_1754058115529.trails_id_seq OWNED BY staging_boulder_1754058115529.trails.id;
...
--
-- Name: intersection_points id; Type: DEFAULT; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017717775.intersection_points ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754017717775.intersection_points_id_seq'::regclass);


--
-- Name: routing_edges id; Type: DEFAULT; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017717775.routing_edges ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754017717775.routing_edges_id_seq'::regclass);


--
-- Name: routing_nodes id; Type: DEFAULT; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017717775.routing_nodes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754017717775.routing_nodes_id_seq'::regclass);


--
-- Name: trail_hashes id; Type: DEFAULT; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017717775.trail_hashes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754017717775.trail_hashes_id_seq'::regclass);


--
-- Name: trails id; Type: DEFAULT; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017717775.trails ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754017717775.trails_id_seq'::regclass);


--
-- Name: intersection_points id; Type: DEFAULT; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017877721.intersection_points ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754017877721.intersection_points_id_seq'::regclass);


--
-- Name: routing_edges id; Type: DEFAULT; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017877721.routing_edges ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754017877721.routing_edges_id_seq'::regclass);


--
-- Name: routing_nodes id; Type: DEFAULT; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017877721.routing_nodes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754017877721.routing_nodes_id_seq'::regclass);


--
-- Name: trail_hashes id; Type: DEFAULT; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017877721.trail_hashes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754017877721.trail_hashes_id_seq'::regclass);


--
-- Name: trails id; Type: DEFAULT; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017877721.trails ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754017877721.trails_id_seq'::regclass);


--
-- Name: intersection_points id; Type: DEFAULT; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754018197814.intersection_points ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754018197814.intersection_points_id_seq'::regclass);


--
-- Name: routing_edges id; Type: DEFAULT; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754018197814.routing_edges ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754018197814.routing_edges_id_seq'::regclass);


--
-- Name: routing_nodes id; Type: DEFAULT; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754018197814.routing_nodes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754018197814.routing_nodes_id_seq'::regclass);


--
-- Name: trail_hashes id; Type: DEFAULT; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754018197814.trail_hashes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754018197814.trail_hashes_id_seq'::regclass);


--
-- Name: trails id; Type: DEFAULT; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754018197814.trails ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754018197814.trails_id_seq'::regclass);


--
-- Name: intersection_points id; Type: DEFAULT; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754058115529.intersection_points ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754058115529.intersection_points_id_seq'::regclass);


--
-- Name: routing_edges id; Type: DEFAULT; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754058115529.routing_edges ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754058115529.routing_edges_id_seq'::regclass);


--
-- Name: routing_nodes id; Type: DEFAULT; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754058115529.routing_nodes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754058115529.routing_nodes_id_seq'::regclass);


--
-- Name: trail_hashes id; Type: DEFAULT; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754058115529.trail_hashes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754058115529.trail_hashes_id_seq'::regclass);


--
-- Name: trails id; Type: DEFAULT; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754058115529.trails ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754058115529.trails_id_seq'::regclass);
...
--
-- Name: route_patterns route_patterns_pattern_name_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.route_patterns
    ADD CONSTRAINT route_patterns_pattern_name_unique UNIQUE (pattern_name);
...
--
-- Name: intersection_points intersection_points_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017717775.intersection_points
    ADD CONSTRAINT intersection_points_pkey PRIMARY KEY (id);


--
-- Name: routing_edges routing_edges_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017717775.routing_edges
    ADD CONSTRAINT routing_edges_pkey PRIMARY KEY (id);


--
-- Name: routing_nodes routing_nodes_node_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017717775.routing_nodes
    ADD CONSTRAINT routing_nodes_node_uuid_key UNIQUE (node_uuid);


--
-- Name: routing_nodes routing_nodes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754017717775; Owner: -
--
...
--
-- Name: trail_hashes trail_hashes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017717775.trail_hashes
    ADD CONSTRAINT trail_hashes_pkey PRIMARY KEY (id);


--
-- Name: trails trails_app_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017717775.trails
    ADD CONSTRAINT trails_app_uuid_key UNIQUE (app_uuid);


--
-- Name: trails trails_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754017717775; Owner: -
--
...
--
-- Name: intersection_points intersection_points_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017877721.intersection_points
    ADD CONSTRAINT intersection_points_pkey PRIMARY KEY (id);


--
-- Name: routing_edges routing_edges_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017877721.routing_edges
    ADD CONSTRAINT routing_edges_pkey PRIMARY KEY (id);


--
-- Name: routing_nodes routing_nodes_node_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017877721.routing_nodes
    ADD CONSTRAINT routing_nodes_node_uuid_key UNIQUE (node_uuid);


--
-- Name: routing_nodes routing_nodes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754017877721; Owner: -
--
...
--
-- Name: trail_hashes trail_hashes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017877721.trail_hashes
    ADD CONSTRAINT trail_hashes_pkey PRIMARY KEY (id);


--
-- Name: trails trails_app_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017877721.trails
    ADD CONSTRAINT trails_app_uuid_key UNIQUE (app_uuid);


--
-- Name: trails trails_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754017877721; Owner: -
--
...
--
-- Name: intersection_points intersection_points_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754018197814.intersection_points
    ADD CONSTRAINT intersection_points_pkey PRIMARY KEY (id);


--
-- Name: routing_edges routing_edges_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754018197814.routing_edges
    ADD CONSTRAINT routing_edges_pkey PRIMARY KEY (id);


--
-- Name: routing_nodes routing_nodes_node_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754018197814.routing_nodes
    ADD CONSTRAINT routing_nodes_node_uuid_key UNIQUE (node_uuid);


--
-- Name: routing_nodes routing_nodes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754018197814; Owner: -
--
...
--
-- Name: trail_hashes trail_hashes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754018197814.trail_hashes
    ADD CONSTRAINT trail_hashes_pkey PRIMARY KEY (id);


--
-- Name: trails trails_app_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754018197814.trails
    ADD CONSTRAINT trails_app_uuid_key UNIQUE (app_uuid);


--
-- Name: trails trails_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754018197814; Owner: -
--
...
--
-- Name: intersection_points intersection_points_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754058115529.intersection_points
    ADD CONSTRAINT intersection_points_pkey PRIMARY KEY (id);


--
-- Name: routing_edges routing_edges_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754058115529.routing_edges
    ADD CONSTRAINT routing_edges_pkey PRIMARY KEY (id);


--
-- Name: routing_nodes routing_nodes_node_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754058115529.routing_nodes
    ADD CONSTRAINT routing_nodes_node_uuid_key UNIQUE (node_uuid);


--
-- Name: routing_nodes routing_nodes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754058115529; Owner: -
--
...
--
-- Name: trail_hashes trail_hashes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754058115529.trail_hashes
    ADD CONSTRAINT trail_hashes_pkey PRIMARY KEY (id);


--
-- Name: trails trails_app_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754058115529.trails
    ADD CONSTRAINT trails_app_uuid_key UNIQUE (app_uuid);


--
-- Name: trails trails_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754058115529; Owner: -
--
...
--
-- Name: idx_staging_boulder_1754017717775_intersection_points; Type: INDEX; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE INDEX idx_staging_boulder_1754017717775_intersection_points ON staging_boulder_1754017717775.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1754017717775_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE INDEX idx_staging_boulder_1754017717775_routing_edges_geometry ON staging_boulder_1754017717775.routing_edges USING gist (geometry);


--
-- Name: idx_staging_boulder_1754017717775_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE INDEX idx_staging_boulder_1754017717775_routing_nodes_location ON staging_boulder_1754017717775.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_boulder_1754017717775_trails_geometry; Type: INDEX; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE INDEX idx_staging_boulder_1754017717775_trails_geometry ON staging_boulder_1754017717775.trails USING gist (geometry);


--
-- Name: idx_staging_intersection_points; Type: INDEX; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE INDEX idx_staging_intersection_points ON staging_boulder_1754017717775.intersection_points USING gist (point);


--
-- Name: idx_staging_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE INDEX idx_staging_routing_edges_geometry ON staging_boulder_1754017717775.routing_edges USING gist (geometry);


--
-- Name: idx_staging_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE INDEX idx_staging_routing_nodes_location ON staging_boulder_1754017717775.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_trails_geometry; Type: INDEX; Schema: staging_boulder_1754017717775; Owner: -
--

CREATE INDEX idx_staging_trails_geometry ON staging_boulder_1754017717775.trails USING gist (geometry);


--
-- Name: idx_intersection_points; Type: INDEX; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE INDEX idx_intersection_points ON staging_boulder_1754017877721.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1754017877721_intersection_points; Type: INDEX; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE INDEX idx_staging_boulder_1754017877721_intersection_points ON staging_boulder_1754017877721.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1754017877721_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE INDEX idx_staging_boulder_1754017877721_routing_edges_geometry ON staging_boulder_1754017877721.routing_edges USING gist (geometry);


--
-- Name: idx_staging_boulder_1754017877721_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE INDEX idx_staging_boulder_1754017877721_routing_nodes_location ON staging_boulder_1754017877721.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_boulder_1754017877721_trails_geometry; Type: INDEX; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE INDEX idx_staging_boulder_1754017877721_trails_geometry ON staging_boulder_1754017877721.trails USING gist (geometry);


--
-- Name: idx_staging_intersection_points; Type: INDEX; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE INDEX idx_staging_intersection_points ON staging_boulder_1754017877721.intersection_points USING gist (point);


--
-- Name: idx_staging_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE INDEX idx_staging_routing_edges_geometry ON staging_boulder_1754017877721.routing_edges USING gist (geometry);


--
-- Name: idx_staging_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE INDEX idx_staging_routing_nodes_location ON staging_boulder_1754017877721.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_trails_geometry; Type: INDEX; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE INDEX idx_staging_trails_geometry ON staging_boulder_1754017877721.trails USING gist (geometry);


--
-- Name: idx_trails_app_uuid; Type: INDEX; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE INDEX idx_trails_app_uuid ON staging_boulder_1754017877721.trails USING btree (app_uuid);


--
-- Name: idx_trails_geometry; Type: INDEX; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE INDEX idx_trails_geometry ON staging_boulder_1754017877721.trails USING gist (geometry);


--
-- Name: idx_trails_name; Type: INDEX; Schema: staging_boulder_1754017877721; Owner: -
--

CREATE INDEX idx_trails_name ON staging_boulder_1754017877721.trails USING btree (name);


--
-- Name: idx_intersection_points; Type: INDEX; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE INDEX idx_intersection_points ON staging_boulder_1754018197814.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1754018197814_intersection_points; Type: INDEX; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE INDEX idx_staging_boulder_1754018197814_intersection_points ON staging_boulder_1754018197814.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1754018197814_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE INDEX idx_staging_boulder_1754018197814_routing_edges_geometry ON staging_boulder_1754018197814.routing_edges USING gist (geometry);


--
-- Name: idx_staging_boulder_1754018197814_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE INDEX idx_staging_boulder_1754018197814_routing_nodes_location ON staging_boulder_1754018197814.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_boulder_1754018197814_trails_geometry; Type: INDEX; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE INDEX idx_staging_boulder_1754018197814_trails_geometry ON staging_boulder_1754018197814.trails USING gist (geometry);


--
-- Name: idx_staging_intersection_points; Type: INDEX; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE INDEX idx_staging_intersection_points ON staging_boulder_1754018197814.intersection_points USING gist (point);


--
-- Name: idx_staging_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE INDEX idx_staging_routing_edges_geometry ON staging_boulder_1754018197814.routing_edges USING gist (geometry);


--
-- Name: idx_staging_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE INDEX idx_staging_routing_nodes_location ON staging_boulder_1754018197814.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_trails_geometry; Type: INDEX; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE INDEX idx_staging_trails_geometry ON staging_boulder_1754018197814.trails USING gist (geometry);


--
-- Name: idx_trails_app_uuid; Type: INDEX; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE INDEX idx_trails_app_uuid ON staging_boulder_1754018197814.trails USING btree (app_uuid);


--
-- Name: idx_trails_geometry; Type: INDEX; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE INDEX idx_trails_geometry ON staging_boulder_1754018197814.trails USING gist (geometry);


--
-- Name: idx_trails_name; Type: INDEX; Schema: staging_boulder_1754018197814; Owner: -
--

CREATE INDEX idx_trails_name ON staging_boulder_1754018197814.trails USING btree (name);


--
-- Name: idx_intersection_points; Type: INDEX; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE INDEX idx_intersection_points ON staging_boulder_1754058115529.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1754058115529_intersection_points; Type: INDEX; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE INDEX idx_staging_boulder_1754058115529_intersection_points ON staging_boulder_1754058115529.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1754058115529_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE INDEX idx_staging_boulder_1754058115529_routing_edges_geometry ON staging_boulder_1754058115529.routing_edges USING gist (geometry);


--
-- Name: idx_staging_boulder_1754058115529_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE INDEX idx_staging_boulder_1754058115529_routing_nodes_location ON staging_boulder_1754058115529.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_boulder_1754058115529_trails_geometry; Type: INDEX; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE INDEX idx_staging_boulder_1754058115529_trails_geometry ON staging_boulder_1754058115529.trails USING gist (geometry);


--
-- Name: idx_staging_intersection_points; Type: INDEX; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE INDEX idx_staging_intersection_points ON staging_boulder_1754058115529.intersection_points USING gist (point);


--
-- Name: idx_staging_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE INDEX idx_staging_routing_edges_geometry ON staging_boulder_1754058115529.routing_edges USING gist (geometry);


--
-- Name: idx_staging_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE INDEX idx_staging_routing_nodes_location ON staging_boulder_1754058115529.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_trails_geometry; Type: INDEX; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE INDEX idx_staging_trails_geometry ON staging_boulder_1754058115529.trails USING gist (geometry);


--
-- Name: idx_trails_app_uuid; Type: INDEX; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE INDEX idx_trails_app_uuid ON staging_boulder_1754058115529.trails USING btree (app_uuid);


--
-- Name: idx_trails_geometry; Type: INDEX; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE INDEX idx_trails_geometry ON staging_boulder_1754058115529.trails USING gist (geometry);


--
-- Name: idx_trails_name; Type: INDEX; Schema: staging_boulder_1754058115529; Owner: -
--

CREATE INDEX idx_trails_name ON staging_boulder_1754058115529.trails USING btree (name);
...
--
-- Name: routing_edges routing_edges_source_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017717775.routing_edges
    ADD CONSTRAINT routing_edges_source_fkey FOREIGN KEY (source) REFERENCES staging_boulder_1754017717775.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_target_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1754017717775; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017717775.routing_edges
    ADD CONSTRAINT routing_edges_target_fkey FOREIGN KEY (target) REFERENCES staging_boulder_1754017717775.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_source_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017877721.routing_edges
    ADD CONSTRAINT routing_edges_source_fkey FOREIGN KEY (source) REFERENCES staging_boulder_1754017877721.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_target_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1754017877721; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754017877721.routing_edges
    ADD CONSTRAINT routing_edges_target_fkey FOREIGN KEY (target) REFERENCES staging_boulder_1754017877721.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_source_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754018197814.routing_edges
    ADD CONSTRAINT routing_edges_source_fkey FOREIGN KEY (source) REFERENCES staging_boulder_1754018197814.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_target_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1754018197814; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754018197814.routing_edges
    ADD CONSTRAINT routing_edges_target_fkey FOREIGN KEY (target) REFERENCES staging_boulder_1754018197814.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_source_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754058115529.routing_edges
    ADD CONSTRAINT routing_edges_source_fkey FOREIGN KEY (source) REFERENCES staging_boulder_1754058115529.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_target_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1754058115529; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754058115529.routing_edges
    ADD CONSTRAINT routing_edges_target_fkey FOREIGN KEY (target) REFERENCES staging_boulder_1754058115529.routing_nodes(id) ON DELETE CASCADE;
