...
async function testPgrCreateTopology() {
  const pool = new Pool(dbConfig);
  
  try {
    console.log('🔍 Testing pgr_createTopology approach for Bear Canyon loop...');
    
    // Test with the working commit parameters (cost <= 5.0)
    ...
    console.log(`🎯 Found ${bearCanyonCycles} cycles containing Bear Canyon nodes with pgr_createTopology approach!`);
