...
exports.validateStagingData = validateStagingData;
exports.calculateAndDisplayRegionBbox = calculateAndDisplayRegionBbox;
async function validateStagingData(pgClient, stagingSchema, region, regionBbox, verbose = false) {
...
async function calculateAndDisplayRegionBbox(pgClient, stagingSchema, region, verbose = false) {
