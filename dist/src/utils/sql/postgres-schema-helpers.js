...
exports.buildMasterDatabase = buildMasterDatabase;
exports.calculateAdaptiveTolerance = calculateAdaptiveTolerance;
exports.estimateDatabaseSize = estimateDatabaseSize;
 ...
 */
async function calculateAdaptiveTolerance(trails, targetSizeMB) {
 ...
 * @returns {Promise<number>}
 */
async function estimateDatabaseSize(trails) {
    // TODO: Implement using SQL/PostGIS
 ...
 */
async function simplifyGeometryWithCounts(wkt, tolerance) {
    // TODO: Implement using SQL/PostGIS
 ...
 */
async function createCanonicalRoutingEdgesTable(pgClient, schemaName) {
...
//# sourceMappingURL=postgres-schema-helpers.js.map