...
class StagingSqlHelpers {
    ...
    async getOriginalTrails(bbox) {
        ...
        const queryParams = [this.config.region];
     ...
     */
    async splitLoopTrail(geometry, trailUuid) {
     ...
     */
    async insertTrailToStaging(trailData) {
        const insertSql = `
     ...
     */
    async copyRegionDataToStaging(bbox) {
...
//# sourceMappingURL=staging-sql-helpers.js.map