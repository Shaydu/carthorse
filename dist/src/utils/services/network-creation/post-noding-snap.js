...
exports.runPostNodingSnap = runPostNodingSnap;
async function runPostNodingSnap(pgClient, stagingSchema, toleranceMeters) {
  ...
  `);
    ...
    await pgClient.query(`UPDATE ${stagingSchema}.ways_noded_vertices_pgr 
     SET cnt = 0 
     WHERE cnt IS NULL`);
...
//# sourceMappingURL=post-noding-snap.js.map