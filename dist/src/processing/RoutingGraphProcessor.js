...
exports.PostgresRoutingGraphProcessor = void 0;
class PostgresRoutingGraphProcessor {
    constructor(routingService, databaseService) {
        this.routingService = routingService;
        this.databaseService = databaseService;
    }
    async buildRoutingGraph(schemaName, config) {
    ...
    async optimizeRoutingGraph(schemaName, config) {
...
exports.PostgresRoutingGraphProcessor = PostgresRoutingGraphProcessor;
//# sourceMappingURL=RoutingGraphProcessor.js.map