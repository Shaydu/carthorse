...
exports.StagingQueries = void 0;
exports.StagingQueries = {
    // Schema creation
  ...
  `,
    // Data validation
    validateStagingData: (schemaName) => `
    SELECT 
  ...
  `,
    ...
    validateTrailsForRouting: (schemaName) => `
    SELECT 
      COUNT(*) as total_trails,
      COUNT(CASE WHEN geometry IS NULL THEN 1 END) as null_geometry,
  ...
  `,
    ...
    getTrailDetails: (schemaName, limit = 10) => `
...
//# sourceMappingURL=staging-queries.js.map