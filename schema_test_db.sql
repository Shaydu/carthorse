            ...
            SELECT 
                ...
                (SELECT n.id 
                 FROM %I.routing_nodes n 
                                 WHERE ST_DWithin(ts.start_point, ST_SetSRID(ST_Point(n.lng, n.lat), 4326), GREATEST(0.001, 0.001))
                ...
                (SELECT n.id 
                 FROM %I.routing_nodes n 
                                 WHERE ST_DWithin(ts.end_point, ST_SetSRID(ST_Point(n.lng, n.lat), 4326), GREATEST(0.001, 0.001))
