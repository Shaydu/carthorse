import { EnhancedPostgresOrchestrator } from '../../carthorse-enhanced-postgres-orchestrator';
import Database from 'better-sqlite3';
import * as fs from 'fs';
import * as path from 'path';

// Mock config for test region
const TEST_REGION = 'testregion';
const TEST_DB_PATH = path.resolve(__dirname, '../../data/testregion.db');
const TEST_OUTPUT_PATH = path.resolve(__dirname, '../../data/testregion-export.db');
