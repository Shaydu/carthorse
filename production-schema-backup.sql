...
--
-- Name: staging_boulder_1754082558091; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA staging_boulder_1754082558091;
...
CREATE FUNCTION public.copy_and_split_trails_to_staging_native(staging_schema text, source_table text, region_filter text, bbox_min_lng real DEFAULT NULL::real, bbox_min_lat real DEFAULT NULL::real, bbox_max_lng real DEFAULT NULL::real, bbox_max_lat real DEFAULT NULL::real, trail_limit integer DEFAULT NULL::integer, tolerance_meters real DEFAULT 1.0) RETURNS TABLE(original_count integer, split_count integer, intersection_count integer, success boolean, message text)
    LANGUAGE plpgsql
    AS $_$
DECLARE
...
CREATE FUNCTION public.detect_trail_intersections(trails_schema text, trails_table text, intersection_tolerance_meters double precision DEFAULT 2.0) RETURNS TABLE(intersection_point public.geometry, intersection_point_3d public.geometry, connected_trail_ids integer[], connected_trail_names text[], node_type text, distance_meters double precision)
    LANGUAGE plpgsql
    AS $_$
BEGIN
...
CREATE FUNCTION public.generate_routing_edges_native(staging_schema text, tolerance_meters real DEFAULT 0.5) RETURNS TABLE(edge_count integer, success boolean, message text)
    LANGUAGE plpgsql
    AS $_$
DECLARE
...
--
-- Name: generate_routing_edges_native_v2(text, real); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.generate_routing_edges_native_v2(staging_schema text, tolerance_meters real DEFAULT 0.5) RETURNS TABLE(edge_count integer, success boolean, message text)
    LANGUAGE plpgsql
    AS $_$
DECLARE
    edge_count_var integer := 0;
...
--
-- Name: generate_routing_nodes_native_v2(text, real); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.generate_routing_nodes_native_v2(staging_schema text, intersection_tolerance_meters real DEFAULT 2.0) RETURNS TABLE(node_count integer, success boolean, message text)
    LANGUAGE plpgsql
    AS $_$
DECLARE
    node_count_var integer := 0;
...
CREATE FUNCTION public.show_routing_summary() RETURNS TABLE(function_name text, version text, description text)
    LANGUAGE plpgsql
...
--
-- Name: intersection_points; Type: TABLE; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE TABLE staging_boulder_1754082558091.intersection_points (
    id integer NOT NULL,
    point public.geometry(Point,4326),
    point_3d public.geometry(PointZ,4326),
    connected_trail_ids text[],
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE SEQUENCE staging_boulder_1754082558091.intersection_points_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: intersection_points_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER SEQUENCE staging_boulder_1754082558091.intersection_points_id_seq OWNED BY staging_boulder_1754082558091.intersection_points.id;


--
-- Name: routing_edges; Type: TABLE; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE TABLE staging_boulder_1754082558091.routing_edges (
    id integer NOT NULL,
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE SEQUENCE staging_boulder_1754082558091.routing_edges_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER SEQUENCE staging_boulder_1754082558091.routing_edges_id_seq OWNED BY staging_boulder_1754082558091.routing_edges.id;


--
-- Name: routing_nodes; Type: TABLE; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE TABLE staging_boulder_1754082558091.routing_nodes (
    id integer NOT NULL,
    node_uuid text,
    lat real,
    lng real,
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE SEQUENCE staging_boulder_1754082558091.routing_nodes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_nodes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER SEQUENCE staging_boulder_1754082558091.routing_nodes_id_seq OWNED BY staging_boulder_1754082558091.routing_nodes.id;


--
-- Name: trail_hashes; Type: TABLE; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE TABLE staging_boulder_1754082558091.trail_hashes (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    geometry_hash text NOT NULL,
    created_at timestamp without time zone DEFAULT now()
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE SEQUENCE staging_boulder_1754082558091.trail_hashes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trail_hashes_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER SEQUENCE staging_boulder_1754082558091.trail_hashes_id_seq OWNED BY staging_boulder_1754082558091.trail_hashes.id;


--
-- Name: trails; Type: TABLE; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE TABLE staging_boulder_1754082558091.trails (
    id integer NOT NULL,
    app_uuid text NOT NULL,
    osm_id text,
    name text NOT NULL,
    ...
    geometry_text text,
    geometry_hash text NOT NULL,
    CONSTRAINT staging_boulder_1754082558091_trails_3d_geometry CHECK ((public.st_ndims(geometry) = 3)),
    CONSTRAINT staging_boulder_1754082558091_trails_valid_geometry CHECK (public.st_isvalid(geometry)),
...
--
-- Name: trails_id_seq; Type: SEQUENCE; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE SEQUENCE staging_boulder_1754082558091.trails_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trails_id_seq; Type: SEQUENCE OWNED BY; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER SEQUENCE staging_boulder_1754082558091.trails_id_seq OWNED BY staging_boulder_1754082558091.trails.id;
...
--
-- Name: routing_edges; Type: TABLE; Schema: test_bbox_debug; Owner: -
--

CREATE TABLE test_bbox_debug.routing_edges (
    id integer NOT NULL,
    source integer,
    target integer,
    trail_id integer,
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE; Schema: test_bbox_debug; Owner: -
--

CREATE SEQUENCE test_bbox_debug.routing_edges_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: routing_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: test_bbox_debug; Owner: -
--

ALTER SEQUENCE test_bbox_debug.routing_edges_id_seq OWNED BY test_bbox_debug.routing_edges.id;


--
-- Name: routing_nodes; Type: TABLE; Schema: test_bbox_debug; Owner: -
--

CREATE TABLE test_bbox_debug.routing_nodes (
    id integer NOT NULL,
    node_uuid text,
    lat real,
    lng real,
...
--
-- Name: intersection_points id; Type: DEFAULT; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754082558091.intersection_points ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754082558091.intersection_points_id_seq'::regclass);


--
-- Name: routing_edges id; Type: DEFAULT; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754082558091.routing_edges ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754082558091.routing_edges_id_seq'::regclass);


--
-- Name: routing_nodes id; Type: DEFAULT; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754082558091.routing_nodes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754082558091.routing_nodes_id_seq'::regclass);


--
-- Name: trail_hashes id; Type: DEFAULT; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754082558091.trail_hashes ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754082558091.trail_hashes_id_seq'::regclass);


--
-- Name: trails id; Type: DEFAULT; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754082558091.trails ALTER COLUMN id SET DEFAULT nextval('staging_boulder_1754082558091.trails_id_seq'::regclass);


--
-- Name: routing_edges id; Type: DEFAULT; Schema: test_bbox_debug; Owner: -
--

ALTER TABLE ONLY test_bbox_debug.routing_edges ALTER COLUMN id SET DEFAULT nextval('test_bbox_debug.routing_edges_id_seq'::regclass);
...
--
-- Name: intersection_points intersection_points_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754082558091.intersection_points
    ADD CONSTRAINT intersection_points_pkey PRIMARY KEY (id);


--
-- Name: routing_edges routing_edges_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754082558091.routing_edges
    ADD CONSTRAINT routing_edges_pkey PRIMARY KEY (id);


--
-- Name: routing_nodes routing_nodes_node_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754082558091.routing_nodes
    ADD CONSTRAINT routing_nodes_node_uuid_key UNIQUE (node_uuid);


--
-- Name: routing_nodes routing_nodes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754082558091; Owner: -
--
...
--
-- Name: trail_hashes trail_hashes_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754082558091.trail_hashes
    ADD CONSTRAINT trail_hashes_pkey PRIMARY KEY (id);


--
-- Name: trails trails_app_uuid_key; Type: CONSTRAINT; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754082558091.trails
    ADD CONSTRAINT trails_app_uuid_key UNIQUE (app_uuid);


--
-- Name: trails trails_pkey; Type: CONSTRAINT; Schema: staging_boulder_1754082558091; Owner: -
--
...
--
-- Name: routing_edges routing_edges_pkey; Type: CONSTRAINT; Schema: test_bbox_debug; Owner: -
--

ALTER TABLE ONLY test_bbox_debug.routing_edges
    ADD CONSTRAINT routing_edges_pkey PRIMARY KEY (id);
...
--
-- Name: idx_intersection_points; Type: INDEX; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE INDEX idx_intersection_points ON staging_boulder_1754082558091.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1754082558091_intersection_points; Type: INDEX; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE INDEX idx_staging_boulder_1754082558091_intersection_points ON staging_boulder_1754082558091.intersection_points USING gist (point);


--
-- Name: idx_staging_boulder_1754082558091_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE INDEX idx_staging_boulder_1754082558091_routing_edges_geometry ON staging_boulder_1754082558091.routing_edges USING gist (geometry);


--
-- Name: idx_staging_boulder_1754082558091_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE INDEX idx_staging_boulder_1754082558091_routing_nodes_location ON staging_boulder_1754082558091.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_boulder_1754082558091_trails_geometry; Type: INDEX; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE INDEX idx_staging_boulder_1754082558091_trails_geometry ON staging_boulder_1754082558091.trails USING gist (geometry);


--
-- Name: idx_staging_intersection_points; Type: INDEX; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE INDEX idx_staging_intersection_points ON staging_boulder_1754082558091.intersection_points USING gist (point);


--
-- Name: idx_staging_routing_edges_geometry; Type: INDEX; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE INDEX idx_staging_routing_edges_geometry ON staging_boulder_1754082558091.routing_edges USING gist (geometry);


--
-- Name: idx_staging_routing_nodes_location; Type: INDEX; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE INDEX idx_staging_routing_nodes_location ON staging_boulder_1754082558091.routing_nodes USING gist (public.st_setsrid(public.st_makepoint((lng)::double precision, (lat)::double precision), 4326));


--
-- Name: idx_staging_trails_geometry; Type: INDEX; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE INDEX idx_staging_trails_geometry ON staging_boulder_1754082558091.trails USING gist (geometry);


--
-- Name: idx_trails_app_uuid; Type: INDEX; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE INDEX idx_trails_app_uuid ON staging_boulder_1754082558091.trails USING btree (app_uuid);


--
-- Name: idx_trails_geometry; Type: INDEX; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE INDEX idx_trails_geometry ON staging_boulder_1754082558091.trails USING gist (geometry);


--
-- Name: idx_trails_name; Type: INDEX; Schema: staging_boulder_1754082558091; Owner: -
--

CREATE INDEX idx_trails_name ON staging_boulder_1754082558091.trails USING btree (name);
...
--
-- Name: routing_edges routing_edges_source_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754082558091.routing_edges
    ADD CONSTRAINT routing_edges_source_fkey FOREIGN KEY (source) REFERENCES staging_boulder_1754082558091.routing_nodes(id) ON DELETE CASCADE;


--
-- Name: routing_edges routing_edges_target_fkey; Type: FK CONSTRAINT; Schema: staging_boulder_1754082558091; Owner: -
--

ALTER TABLE ONLY staging_boulder_1754082558091.routing_edges
    ADD CONSTRAINT routing_edges_target_fkey FOREIGN KEY (target) REFERENCES staging_boulder_1754082558091.routing_nodes(id) ON DELETE CASCADE;
